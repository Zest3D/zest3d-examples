...
package plugin.examples.render 
{
	 ...
	 */
	public class RTTTextureEffect extends VisualEffectInstance 
	{
		...
		public function RTTTextureEffect( texture:Texture2D, filter:SamplerFilterType = null,
										  coord0: SamplerCoordinateType = null, coord1: SamplerCoordinateType = null ) 
		{
			...
			var vShader: VertexShader = new VertexShader( "Zest3D.RTTTextureEffect", 2, 1, 1, 0, false );
			...
			var pShader: FragmentShader = new FragmentShader( "Zest3D.RTTTextureEffect", 1, 1, 0, 1, false );
