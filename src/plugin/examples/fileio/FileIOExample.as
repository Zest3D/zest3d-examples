package plugin.examples.fileio 
{
	...
	public class FileIOExample extends Zest3DApplication implements IDisposable 
	{
		...
		private var _loadList:Array = [ "assets/textures/texture.cut",
										"assets/textures/texture.pix",
										"assets/textures/texture.dds",
										"assets/textures/texture.jpf",
										"assets/textures/texture.xpm",
										"assets/textures/texture.pnm",
										"assets/textures/texture.pgm",
										"assets/textures/texture.pbm",
										"assets/textures/texture.exr",
										"assets/textures/texture.sgi",
										"assets/textures/texture.lbm",
		...
		override protected function initialize():void 
		{
			...
			//_texture.load( "assets/textures/texture.pix" );
			//_texture.load( "assets/textures/texture.cut" );
		...
		{
			_torus.rotationZ = appTime;
			_torus.rotationY = appTime;
